...
CREATE TABLE "User" (
    ...
    "referredById" TEXT,
    "wheelRewardClaimed" BOOLEAN NOT NULL DEFAULT false,
    "wheelRewardCents" INTEGER NOT NULL DEFAULT 0,
    "wheelRewardClaimedAt" TIMESTAMP(3),
